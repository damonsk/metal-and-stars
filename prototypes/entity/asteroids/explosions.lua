...
local mirandite_asteroids_sounds = require ("__planet-machina__.prototypes.entity.asteroids.sounds")
...
data:extend({
   ...
   --mirandite-small
  {
    ...
    icon = "__planet-machina__/graphics/icons/small-mirandite-asteroid.png",
    flags = {"not-on-map"},
    hidden = true,
    height = 0,
  ...
  --mirandite-medium
  {
    ...
    icon = "__planet-machina__/graphics/icons/medium-mirandite-asteroid.png",
    flags = {"not-on-map"},
    hidden = true,
    height = 0,
  ...
  --mirandite-big
  {
    ...
    icon = "__planet-machina__/graphics/icons/big-mirandite-asteroid.png",
    flags = {"not-on-map"},
    hidden = true,
    height = 0,
  ...
  --mirandite-huge
  {
    ...
    icon = "__planet-machina__/graphics/icons/huge-mirandite-asteroid.png",
    flags = {"not-on-map"},
    hidden = true,
    height = 0,
