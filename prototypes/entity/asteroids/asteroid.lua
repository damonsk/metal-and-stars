...
local simulations = require("__planet-machina__.prototypes.entity.asteroids.factoriopedia-simulations")
...
local function asteroid_variation(asteroid_type, suffix, scale, size)
  ...
  {
    color_texture = {
      filename = "__planet-machina__/graphics/entity/asteroid/".. asteroid_type .."/"..asteroid_sizes[size].."/".."asteroid-" .. asteroid_type .. "-" .. asteroid_sizes[size] .. "-colour-" .. suffix .. ".png",
    ...
    normal_map = {
      filename = "__space-age__/graphics/entity/asteroid/carbonic/"..asteroid_sizes[size].."/".."asteroid-carbonic-" .. asteroid_sizes[size] .. "-normal-" .. suffix .. ".png",
      premul_alpha = false,
      size = sizes_resolution[size][1],
      scale = scale
    },
    ...
    roughness_map = {
      filename = "__space-age__/graphics/entity/asteroid/carbonic/"..asteroid_sizes[size].."/".."asteroid-carbonic-" .. asteroid_sizes[size] .. "-roughness-" .. suffix .. ".png",
      premul_alpha = false,
      size = sizes_resolution[size][1],
      scale = scale
    }
...
for asteroid_size, asteroid_size_name in pairs(asteroid_sizes) do
  for asteroid_type, asteroid_data in pairs(asteroids_data) do
    ...
    local variations ={}
    if (asteroid_type == "mirandite") then
      if (asteroid_size_name == "chunk") then
    ...
    data:extend({
      {
        ...
        icon = "__planet-machina__/graphics/icons/"..asteroid_name..".png",
        icon_size = 64,
...
data.raw["asteroid-chunk"]["mirandite-asteroid-chunk"].graphics_set.lights[2] = { color = {0.85,0.5,0.4}, direction = {-1,-45,0.1} }