...
data:extend({
  ...
  ----------- "DEEP" water
  {
     ...
     -----------//////////////////////////////////////////////////////////////GRASS-2 - potato
    {
      ...
      subgroup = "nauvis-tiles",
      collision_mask = tile_collision_masks.ground(),
      autoplace = {probability_expression = 'volcanic_ash_flats_range'},
      layer = 28,
      variants = tile_variations_template(
    ...
    },
    {
      ...
      subgroup = "nauvis-tiles",
      collision_mask = tile_collision_masks.ground(),
      autoplace = {probability_expression = 'volcanic_ash_light_range'},
      layer = 28,
      variants = tile_variations_template(
    ...
    },
    {
      ...
      subgroup = "nauvis-tiles",
      collision_mask = tile_collision_masks.ground(),
      autoplace = {probability_expression = 'volcanic_ash_dark_range'},
      layer = 28,
      variants = tile_variations_template(
  ...
  -----------//////////////////////////////////////////////////////////////GRASS-4
    ...
    ----------UNDERGROWTH TILES
    {
      ...
      order = "b[natural]-a[grass]-a[grass-1]",
      collision_mask = tile_collision_masks.ground(),
      autoplace = {probability_expression = 'ringworld_left_mask'},
      layer = 26,
      variants = tile_variations_template(
