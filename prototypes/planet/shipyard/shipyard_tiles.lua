...
data:extend
{
  ...
  ----- Gray Goo
  {
    ...
    variants = tile_variations_template_with_transitions(
      "__planet-machina__/graphics/terrain/gray-goo-ocean.png",
      {
        max_size = 4,
  ...
  ----- Gray Goo effect
  {
    ...
    water =
    {
      ...
      textures =
      {
        ...
        {
          filename = "__planet-machina__/graphics/terrain/gray-goo-gradient.png",
          width = 512,
          height = 32
        },
        --specular highligts
        {
          filename = "__planet-machina__/graphics/terrain/gray-goo-spec.png",
          width = 512 * 4,
          height = 512 * 2
        },
      },
